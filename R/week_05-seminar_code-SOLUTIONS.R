#
# file: week_05-seminar_code-SOLUTIONS.R
...
write_csv(
  hot_songs, 
  here("data", "billboard_hot_songs.csv")
  )
...
# the square brackets. Two things to note here:

# - we use 'escape' characters "\\[" and "\\]" to match 
# the literal bracket characters

# - we use the "?" before the "\\]" to tell the regex 
# search to be 'non-greedy', that is, look for 0 or more 
# instances of any character (".*") until it gets to the 
# FIRST instance of "\\]"
...
# This is much trickier. Consider the first part of the 
# third song: 
