...
![How filing systems used to work](../_images/blue-filing-cabinet.jpg){#fig-rstudio fig-align="left" fig-alt="Filing cabinet" width="60%"}
...
#| fig-width: 5
#| fig-height: 4
knitr::include_graphics("../_images/folder_structure.png")
```
